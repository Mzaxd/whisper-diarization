...
# 源目录和目标目录路径
source_dir = r"D:\英语资料\EnglishPod_v2.0\source"
target_dir = r"D:\英语资料\EnglishPod_v2.0\target"
...
# 指定处理的文件范围
# start_file_number = 11
# end_file_number = 365

file_indices = [5, 11, 23, 30, 31, 133, 139, 141, 147, 157, 161, 170, 174, 175, 181, 188, 200, 201, 207, 214, 215, 217, 220,
